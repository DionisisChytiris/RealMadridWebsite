  ...
  return (
    <>
      <div className="cnt-hm-sct1-pt1">
        ...
        Real Madrid's league, Copa del Rey and Super Cup treble in basketball
        </div>
        <div className="cnt-hm-tx1-md">
        Chus Mateo's team smashed their record number of wins in a season with 72 victories. 
        </div>
        <div className="cnt-hm-img1">
          <img src={assetsHm.BalonceloTrofeos} alt="trofeos" />
        </div>
